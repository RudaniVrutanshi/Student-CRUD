...
public class showAllData extends HttpServlet {
	...
	out.println("<!DOCTYPE html>");
		...
		out.print("<td><a href='update.html'><button><i class='fa fa-pencil' aria-hidden='true'></i></button></a></td>");
		out.print("<td><a href='delete.html'><button><i class='fa fa-trash' aria-hidden='true'></i></button></a></td>");
		out.print("</tr>");
		}
		out.print("<tr><td colspan=6 style='text-align:center'><a href='navbar.html'><Button><i class='fa fa-home' aria-hidden='true'></i></Button></a></td></tr>");
		out.print("</table>");
		out.print("</body>");
		out.print("</html>");
